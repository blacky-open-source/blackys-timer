...
MySQL server 		      - (No recommendation)
...
It also generates a wrsounds.cfg in addons/sourcemod/configs/timer where you can list sounds that are played when someone gets a new record.
For example, writing:

fanfare0.wav

in wrsounds.cfg will play the sound located at cstrike/download/sound/btimes/fanfare0.wav
